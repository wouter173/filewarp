...
export default function ConfirmDialog() {
  ...
  const handleConfirm = () => {
    ...
    dispatch(setDialogOpen({ dialog: "sendDialog", open: false }));
    dispatch(resetPeer());
    WebRTC.close();
  };
      ...
      >
        ...
        >
          <div className="fixed bg-white w-auto h-min p-8 rounded-lg max-w-sm">
            ...
            <p className="block text-xs my-6">
              the connection will be broken and all in transfer files will be canceled
            </p>
